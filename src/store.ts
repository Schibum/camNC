...
const defaultCalibrationData: CalibrationData = {
  calibration_matrix: [
    [2718.356778549516, 0.0, 1330.9722390494142],
    [0.0, 2720.983113052985, 950.8828504603558],
    [0.0, 0.0, 1.0],
  ],
  // prettier-ignore
  new_camera_matrix: new Matrix3().set(
    2470.9114501953127, 0.0, 1343.6603191679794,
    0.0, 2567.0676025390626, 953.2567830356857,
    0.0, 0.0, 1.0,
  ),
  distortion_coefficients: [[-0.35353943419205464, 0.13366263133095185, 0.0027466007365580477, 0.0011168240367295753, -0.01474897186559844]],
};
