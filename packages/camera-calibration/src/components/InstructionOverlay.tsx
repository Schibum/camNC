...
export function InstructionOverlay() {
  ...
  const isAutoCaptureEnabled = useCalibrationStore(state => state.isAutoCaptureEnabled);
  ...
  }, [isAutoCaptureEnabled, isFullyReady, currentCorners, patternSize, rejectedReason]);
