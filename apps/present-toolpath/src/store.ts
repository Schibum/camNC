...
const defaultCalibrationData: CalibrationData = {
  calibration_matrix: [
    [1976.815240448295, 0, 1259.6318528813674],
    [0, 1980.7893316734942, 931.0489371815912],
    [0, 0, 1],
  ],
  // prettier-ignore
  new_camera_matrix: new Matrix3().set(
    1784.69837646, 0, 1301.46520762,
    0, 1855.69029541, 943.12181339,
    0, 0, 1,
  ),
  distortion_coefficients: [[-0.22631564020098782, 0.12799507728728043, 0.008049533287753497, 0.012289808220377948, -0.05990404444612661]],
};
