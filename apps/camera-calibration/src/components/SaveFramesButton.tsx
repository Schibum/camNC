...
export const SaveFramesButton = () => {
    ...
    const handleSaveFrames = async () => {
        ...
        try {
            ...
            if (zipWriter) {
                try { await zipWriter.close(); } catch (closeErr) { /* Ignore */ }
            }
        } finally {
            setIsSaving(false);
    ...
    return (
        <div className="flex flex-col items-end">
            <button
                ...
                className="save-button bg-blue-600 text-white rounded px-4 py-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
